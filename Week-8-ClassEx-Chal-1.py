#Jinny Choe
#4/17/2023
#Week 9 Class Exercise Challenge #1
...
#creates Student3 object
Student3 = Students()
Student3.Lastname = input("Enter Student 3 last name: ")
Student3.Firstname = input("Enter Student 3 first name: ")
Student3.Address = input("Enter Student 3 address: ")
Student3. City = input("Enter Student 3 city: ")
Student3.State = input("Enter Student 3 state: ")
Student3.Zipcode =  input("Enter Student 3 zipcode: ")
