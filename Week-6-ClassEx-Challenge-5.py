...
lblLastname = tk.Label(win, text="Last name: ").grid(column=0, row=0)  # label widget
lblFirstname = tk.Label(win, text="First name: ").grid(column=0, row=1)
...
txtLastname = tk.Entry(win, width=35, textvariable=LN).grid(column=1, row=0)  # text entry widget

FN = tk.StringVar()
txtFirstname = tk.Entry(win, width=35, textvariable=FN).grid(column=1, row=1)
